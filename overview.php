    ...
    <div style="background: url('http://diversityhrsolutions.com/wp-content/uploads/2016/05/Great-Cover-Letter-Banner.jpg');">
        <div class="text-center" style="margin:40px;">
            <div class="col-md-12 pt-100">
               <a class="blog-heading mt-50">THE OVERVIEW</a>
            </div>
            ...
            <div class="row text-left">
                ...
                <div class="col-lg-6">
                    <div class="_active-feature-carusel" style="text-align: center;margin-top:50px;">
                        <img class="img-fluid" src="img/Stewardess+CV+17.compressed_Page_1.png" alt="" width="80%" style="height:500px;margin-top:-100px;">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="row">
                    <div class="col-lg-3 col-md-4">
                        <div class="icon">
                            <img class="img-fluid" src="img/1_blue.png" alt="">
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="icon">
                            <img class="img-fluid" src="img/2_blue.png" alt="">
                        </div>
                        <div class="single-stat d-flex flex-row">
                            <div class="icon mr-20">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="icon">
                            <img class="img-fluid" src="img/3_blue.png" alt="">
                        </div>
                        <div class="single-stat d-flex flex-row">
                            <div class="icon mr-20">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="icon">
                            <img class="img-fluid" src="img/4_blue.png" alt="">
                        </div>
                        <div class="single-stat d-flex flex-row">
                            <div class="icon mr-20">
